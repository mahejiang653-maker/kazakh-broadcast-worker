...
const ISO2={RUS:'ru',UKR:'ua',SAU:'sa',YEM:'ye',USA:'us',IRN:'ir',OMN:'om',MDA:'md',BEL:'be',QAT:'qa',ARE:'ae',PSE:'ps',CHN:'cn',FRA:'fr',CHE:'ch',PRK:'kp',KOR:'kr',JPN:'jp',DEU:'de',GBR:'gb',POL:'pl',TUR:'tr',ISR:'il',LBN:'lb',SYR:'sy',IND:'in',PAK:'pk',KAZ:'kz'};const NAME={RUS:'俄罗斯',UKR:'乌克兰',SAU:'沙特阿拉伯',YEM:'也门',USA:'美国',IRN:'伊朗',OMN:'阿曼',MDA:'摩尔多瓦',BEL:'比利时',QAT:'卡塔尔',ARE:'阿联酋',PSE:'巴勒斯坦',CHN:'中国',FRA:'法国',CHE:'瑞士',PRK:'朝鲜',KOR:'韩国',JPN:'日本',DEU:'德国',GBR:'英国',POL:'波兰',TUR:'土耳其',ISR:'以色列',LBN:'黎巴嫩',SYR:'叙利亚',IND:'印度',PAK:'巴基斯坦',KAZ:'哈萨克斯坦'};
let storyIsos=[];
